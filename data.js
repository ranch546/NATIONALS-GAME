...
AN.START_LIFELINE_SHIELDS = 3; // 50/50 uses per quiz level (resets each Easy / Medium / Hard)
AN.LIFELINE_SHIELD_COST = 10;  // Points deducted when using a lifeline shield
